...
from src.analysis.ga.rwa import Binner, rwa, raw_data, RWAMatrix, normalize_and_geometric_mean_rwas, get_next
...
class MultiDimAndLineageTestCase(TestCase):
    ...
    def test_compare_raw_data_sum_to_rwa_max(self):
        ...
        response_weighted_average_multiplied = normalize_and_geometric_mean_rwas(response_weighted_averages)
    ...
    def test_multi_dim_rwa(self):
        ...
        response_weighted_average = normalize_and_geometric_mean_rwas([response_weighted_average_1, response_weighted_average_2])
