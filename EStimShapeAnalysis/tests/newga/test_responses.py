...
class TestResponseModuleFunctions(TestCase):
    ...
    def test_parse_spike_count(self):
        ...
        print(response_parser.parse_spike_count_for_task(1))
        print(response_parser.parse_spike_count_for_task(2))
        print(response_parser.parse_spike_count_for_task(3))

        spike_tstamps_for_channels = fetch_spike_tstamps_from_file(response_parser.path_to_spike_file(1))
        # collapse values
        spike_tstamps = spike_tstamps_for_channels['B-025']
