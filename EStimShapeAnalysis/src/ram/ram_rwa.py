...
from src.analysis.ga.rwa import AutomaticBinner, rwa, raw_data, get_next, normalize_and_geometric_mean_rwas
...
def main():
    ...
    response_weighted_averages = [response_weighted_average_1, response_weighted_average_2,
                                  normalize_and_geometric_mean_rwas([response_weighted_average_1, response_weighted_average_2])]
