...
def main():
    ...
    plot_psychometric_curve_on_ax(data_procedural, axes[0], title='Procedural Trials', show_n=True, num_rep_min=0)

    plot_psychometric_curve_on_ax(data_psychometric, axes[1], title='Pyschometric Trials', show_n=True,
                                  num_rep_min=0)

    plot_psychometric_curve_on_ax(data_psychometric_untouched, axes[2], title='Pyschometric Trials - Untouched', show_n=True,
                                  num_rep_min=0)
