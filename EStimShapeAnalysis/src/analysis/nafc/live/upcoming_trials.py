...
# Grouping dimensions checked by default in the GUI panel. Coherence and generation are included
# so coherence trials split by coherence value and trials split by generation.
DEFAULT_GROUP_DIMENSIONS = ['trial_type', 'estim_spec_id', 'noise_chance', 'coherence', 'gen_id']
