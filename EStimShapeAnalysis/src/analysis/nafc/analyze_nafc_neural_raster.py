...
INTAN_BASE_PATH = "/path/to/intan/nafc_recordings"  # flat dir of {task_id}_* folders
...
def main():
    ...
    # Field order matters: child fields must come after the parents they chain from
    ...
    print(f"After StimType filter: {len(data)} trials")
    if data.empty:
