...
def main():
    ...
    parent_directories = [
        ...
        "/run/user/1000/gvfs/sftp:host=172.30.9.78/mnt/data/EStimShape/allen_ga_exp_251016_0",
        "/run/user/1000/gvfs/sftp:host=172.30.9.78/mnt/data/EStimShape/allen_isogabor_exp_251016_0",
        "/run/user/1000/gvfs/sftp:host=172.30.9.78/mnt/data/EStimShape/allen_lightness_exp_251016_0",
        "/run/user/1000/gvfs/sftp:host=172.30.9.78/mnt/data/EStimShape/allen_shuffle_exp_251016_0",
