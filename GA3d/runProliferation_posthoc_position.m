function [message,nStim] = runProliferation_posthoc_position(folderName,gaInfo,conn)
    ...
    for linNum=1:2
        ...
        while jj <= nPosthoc*nVariantConds
            ...
            switch mod(jj,nVariantConds)
                case 0;  stim = parentStim; % original; do nothing
                case 1;  stim.shape.x = stim.shape.x + 5; % 5mm is about 0.5 vis deg
                case 2;  stim.shape.x = stim.shape.x - 5;
                case 3; stim.shape.y = stim.shape.y + 5;
                case 4; stim.shape.y = stim.shape.y - 5;
                    
                % case 6;  stim.shape.s = stim.shape.s * 1.3;
                % case 7;  stim.shape.s = stim.shape.s * 0.7;
            end
