...
Pstate.param{29} = {'redgain' 'float'   1       0             ''};
Pstate.param{30} = {'greengain' 'float'   1       0             ''};
Pstate.param{31} = {'bluegain' 'float'   1       0             ''};

Pstate.param{32} = {'redbase' 'float'   .5       0             ''};
Pstate.param{33} = {'greenbase' 'float'   .5       0             ''};
Pstate.param{34} = {'bluebase' 'float'   .5       0             ''};

Pstate.param{35} = {'colorspace' 'string'   'gray'       0             ''};

Pstate.param{36} = {'FourierBit'   'int'   0       0                ''};

Pstate.param{37} = {'rseed'    'int'   1       0                ''};

Pstate.param{38} = {'blankProb'    'float'   0       0                ''};

Pstate.param{39} = {'eye_bit'    'int'   0       0                ''};
