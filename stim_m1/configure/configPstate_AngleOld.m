...
Pstate.param{9} = {'stimsmooth'      'int'     0       1                ''};
Pstate.param{10} = {'stimtype'      'int'     0       1                'L, CV, CC'};
Pstate.param{11} = {'linewidth'      'int'     10       1                '% radius'};
...
Pstate.param{16} = {'contrast' 'float'   100       0             '%'};
Pstate.param{17} = {'mouse_bit'    'int'   0       0                ''};
