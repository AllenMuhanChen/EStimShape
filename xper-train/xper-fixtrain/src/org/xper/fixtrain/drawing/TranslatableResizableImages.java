...
public class TranslatableResizableImages {
    ...
    public void draw(Context context, int textureIndex, Coordinates2D location, Coordinates2D dimensions) {
        ...
        float width = (float) context.getRenderer().deg2mm((float)dimensions.getX()); // texture.getImageWidth();
        float height = (float) context.getRenderer().deg2mm((float)dimensions.getY()); // texture.getImageHeight();
