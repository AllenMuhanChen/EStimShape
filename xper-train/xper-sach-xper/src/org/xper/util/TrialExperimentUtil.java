...
//				System.out.println("Frame number: " + currentContext.getAnimationFrameIndex());
				drawingController.animateSlide(currentTask,currentContext);
...
//		drawingController.prepareFirstSlide(currentTask, currentContext);
		...
		drawingController.redrawFirstSlide(currentTask, currentContext);
