...
//					boolean isBubbles) {
			dbUtil.writeReadyGenerationInfo(genInfo.getGenId(),genInfo.getTaskCount(),genInfo.getStimPerLinCount(),
					genInfo.getStimPerTrial(), genInfo.getRepsPerStim());
		}
...
//				boolean isBubbles) {
		...
		dbUtil.updateReadyGenerationInfo(genInfo.getGenId(), genInfo.getTaskCount(),
				...
				genInfo.getRepsPerStim(), genInfo.getUseStereoRenderer());
