...
//		  Vector3d nowvec = new Vector3d(0,0,0);
    ...
    */
    ...
    public static void switchTrialMode(int length, int nShape, DbUtil dbUtil, long tstamp)
    {
    	
    	String staticLen = Integer.toString(length);
    	String numShowStatic = Integer.toString(nShape);
    	
    	dbUtil.writeSystemVar("xper_slide_length", 0, staticLen, tstamp);
		dbUtil.writeSystemVar("xper_slides_per_trial",0, numShowStatic, tstamp);	
