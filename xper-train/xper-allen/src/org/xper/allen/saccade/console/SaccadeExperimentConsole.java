...
public class SaccadeExperimentConsole extends JFrame implements
	...
	@Dependency
	SaccadeExperimentConsoleRenderer consoleRenderer;
...
//		}
	...
	public SaccadeExperimentConsoleRenderer getConsoleRenderer() {
		return consoleRenderer;
	}

	public void setConsoleRenderer(SaccadeExperimentConsoleRenderer consoleRenderer) {
		this.consoleRenderer = consoleRenderer;
	}

	public SaccadeExperimentConsoleModel getModel() {
		return model;
	}

	public void setModel(SaccadeExperimentConsoleModel model) {
		this.model = model;
	}
