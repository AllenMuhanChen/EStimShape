...
public class PsychometricBlockGen extends AbstractPsychometricTrialGenerator<Stim> {
    ...
    private void addPsychometricTrials(PsychometricFactoryParameters psychometricFactoryParameters) {
        ...
        getStims().addAll(psychometricFactory.createTrials());
    }
    ...
    protected void addRandTrials(RandFactoryParameters randFactoryParameters) {
        ...
        getStims().addAll(randFactory.createTrials());
    }
