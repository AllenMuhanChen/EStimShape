...
public class UnderlyingTexturePropertyManager extends StimPropertyManager<String> {
    private static final String TABLE_NAME = "StimUnderlyingTexture";

    public UnderlyingTexturePropertyManager(JdbcTemplate jdbcTemplate) {
        super(jdbcTemplate);
    }
